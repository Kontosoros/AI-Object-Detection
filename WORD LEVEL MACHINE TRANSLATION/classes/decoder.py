...
#                                                               None, self.batch_sz*[vocab_size], self.attention_type)
...
#   def call(self, inputs, initial_state,vocab_size):
#     x = self.embedding(inputs)
#     outputs, _, _ = self.decoder(x, initial_state=initial_state, sequence_length=self.batch_sz*[vocab_size -1])
#     return outputs
